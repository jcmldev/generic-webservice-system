...
public interface GWS {
     ...
     * @param methodId
     * @return
     *     returns javax.xml.ws.Response<dd.genericclient2.InvokeMethodResponse>
     */
    @WebMethod(operationName = "invokeMethod")
    @RequestWrapper(localName = "invokeMethod", targetNamespace = "http://genericws.dd/", className = "dd.genericclient2.InvokeMethod")
    @ResponseWrapper(localName = "invokeMethodResponse", targetNamespace = "http://genericws.dd/", className = "dd.genericclient2.InvokeMethodResponse")
